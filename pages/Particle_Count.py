...
# 특정 열만 선택하기 (U100, U75, U50, U25, U20, U14, U6, U4)
columns_to_display = ['COMPONENT_ARBITRARY', 'U100', 'U75', 'U50', 'U25', 'U20', 'U14', 'U6', 'U4']
...
# 추가적인 설명을 위한 텍스트 블록
st.write("""
    COMPONENT2에서 입자크기를 분석했다는 것을 알 수 있다.
""")

# COMPONENT_ARBITRARY가 'COMPONENT1'인 데이터 필터링
df_component1 = df[df['COMPONENT_ARBITRARY'] == 'COMPONENT2']

# 변수 리스트 (U100, U75, U50, U25, U20, U14, U6, U4)
variables = ['U100', 'U75', 'U50', 'U25', 'U20', 'U14', 'U6', 'U4']

# 드롭다운 형태로 변수 선택
selected_variable = st.selectbox('변수 선택', variables)

# 선택한 변수에 대한 Y_LABEL의 분포를 violin plot으로 시각화
st.write(f'### {selected_variable} 값에 따른 Y_LABEL 분포 (COMPONENT_ARBITRARY = COMPONENT2)')
